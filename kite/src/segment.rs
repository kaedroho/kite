...
pub trait Segment {
    ...
    fn load_stored_field_value_raw(&self, doc_position: u16, field_id: FieldId, value_type: &[u8]) -> Result<Option<Vec<u8>>, String>;
    ...
    fn doc_id(&self, doc_position: u16) -> DocId {
        DocId(self.id(), doc_position)
    }
}
